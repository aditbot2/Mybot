let handler = async (m, { conn, usedPrefix }) => conn.sendButton(m.chat, `“${fakta.getRandom()}”`, author, ['FAKTA', ``], m)
...
// https://jalantikus.com/tips/kata-kata-fakta/
const fakta = [
...
"Pada Sept1909 malam hari, warga Jakarta beruntung menyaksikan Aurora Borealis di langit yg biasanya hanya di kutub.",
...
"Jika kita terkunci diruang yang kedap udara, kita akan lebih dulu mati keracunan co2 dari pada kekurangan o2.",
...
"Ada rata-rata 178 biji wijen dalam roti McDonald’s Big Mac.",
"Perbandingan jumlah rayap dan manusia di dunia adalah 10:1.",
"Kitab Injil telah diterjemahkan ke dalam bahasa Klingon.",
"Musim panas tahun 2003 di Eropa menewaskan 35.000 orang.",
"Staphylococcus aureus hidup pada kulit manusia.",
"Rata-rata manusia memproduksi 25.000 quarts/ukuran 0.9463 liter ludah dalam seumur hidup.",
"Ada Teori Bumi tidak bundar tapi elips.",
"Tingkat kecenderungan perempuan hamil makan lebih banyak jika mereka mengandung bayi laki-laki.",
...
"Gunung. Everest, pada 8848 dan 29.028 meter kaki, adalah gunung tertinggi di dunia.",
...
"Nama asli Albert Brook adalah Albert Einstein.",
"Mengunyah permen karet saat mengupas bawang akan melindungi Anda dari menangis.",
"Satu pound sama dengan lemak 4000 kalori.",
...
"Berat bakteri adalah 1 triliun dari 1 gram.",
"Warga Eskimo menggunakan kulkas untuk menyimpan makanan supaya tidak beku.",
"Kalimat  The quick brown fox jumps over the lazy dog, menggunakan setiap huruf dalam abjad.",
"Rata-rata rentang waktu bermain dalam sebuah liga utama baseball adalah 7 pitches.",
"Kata yang diucapkan tanpa mengulangi huruf adalah kata uncopyrightable.",
"Perpustakaan Utama Universitas Indiana bertambah lebih dari 1 inci hampir setiap tahun dengan buku tebal.",
...
"Hanya 22% dari hutan asli tetap ada di bumi.",
...
"Reno, Nevada adalah barat Los Angeles, California",
...
"Pada tahun 1980, pekerja di sebuah rumah sakit Las Vegas diberhentikan. Mereka bertaruh siapa pasien yang akan mati terlebih dahulu.",
...
"Orang menggunakan kacamata sejak 700 tahun terakhir.",
"Orang yang berusia di atas 100 di AS meningkat dari 4.000 pada tahun 1960 menjadi 55.000 pada tahun 1995.",
"Seekor kucing dapat berlari 20 km per jam.",
"Seekor cheetah dapat berlari 76 km per jam.",
"Katak yang terbesar di dunia adalah Goliath Frog.",
...
"Setiap tahun di India, diperkirakan 300 juta tiket yang dijual."
]